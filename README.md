# Monad Blitz Toronto Submission Process

## Steps to prepare your project repo:

1. Visit the `monad-blitz-toronto` repo (link [here](https://github.com/monad-developers/monad-blitz-toronto)) and fork it.
